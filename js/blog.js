...
function addBlog(event) {
  ...
  let nodeJs = document.getElementById("input-chk-node").checked ? nodeJsIcon : "";
  let nextJs = document.getElementById("input-chk-next").checked ? reactIcon : "";
  let reactJs = document.getElementById("input-chk-react").checked ? javaIcon : "";
  let typeScript = document.getElementById("input-chk-ts").checked ? typeIcon : "";
